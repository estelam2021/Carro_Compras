 ...
 */
final class Version20220309013655 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pedidos ADD talla_pedido_id INT NOT NULL, ADD color_pedido_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE pedidos DROP talla_pedido_id, DROP color_pedido_id');
    }
}
